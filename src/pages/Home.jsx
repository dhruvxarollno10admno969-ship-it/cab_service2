      ...
      <section className="hero-section" id="home">
        ...
        <div className="hero-content">
          ...
          <p className="hero-description">
            Reliable rides for everyday journeys, airport transfers, business
      ...
      <section className="fleet-section" id="fleet">
        <div className="fleet-heading">
          ...
          <p className="fleet-intro">
            From everyday city rides to comfortable long-distance journeys,
        ...
        <div className="fleet-grid">
          ...
          <article className="fleet-card featured">
            <div className="fleet-image">
              <div className="car-placeholder">SEDAN</div>

              <span className="fleet-tag">MOST POPULAR</span>
            </div>

            <div className="fleet-info">
              <div>
                <span className="fleet-type">EVERYDAY</span>
            ...
            <p className="fleet-description">
              Comfortable and efficient for everyday city journeys and airport
              transfers.
            </p>
          ...
          <article className="fleet-card">
            <div className="fleet-image">
              <div className="car-placeholder">SUV</div>
            </div>

            <div className="fleet-info">
              <div>
                <span className="fleet-type">SPACIOUS</span>
            ...
            <p className="fleet-description">
              More space for passengers and luggage without compromising
              comfort.
            </p>
          ...
          <article className="fleet-card">
            <div className="fleet-image">
              <div className="car-placeholder premium-car">PREMIUM</div>
            </div>

            <div className="fleet-info">
              <div>
                <span className="fleet-type">EXECUTIVE</span>
            ...
            <p className="fleet-description">
              A refined ride for business trips, special occasions and premium
              travel.
            </p>
        ...
        <div className="contact-layout">
          ...
          <div className="contact-info">
            <p className="contact-intro">
              Need a ride, have a question, or want to plan a trip? We're here
              to help.
            </p>

            <div className="contact-items">
              {/* PHONE */}
              <a href="tel:+919815489193" className="contact-item">
              ...
              {/* EMAIL */}
              <a href="mailto:hello@manzill777.com" className="contact-item">
